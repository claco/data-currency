...
{
    eval {
        my $currency = Data::Currency->new(1.23, 'BAD');
    };
    like($@, qr/invalid currency code/i);
};
...
{
    eval {
        Data::Currency->converter_class('Bogus');
    };
...
## set converter_class to nothing, and put it back
{
    ...
    is(Data::Currency->converter_class, 'Data::Currency', 'set converter_class');
};
